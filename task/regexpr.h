/*
	$Id: regexpr.h,v 3.2.2.1 2007/07/24 09:58:07 shelton Exp $
*/
#ifndef REGEXPR_H
#define REGEXPR_H
...
typedef re_pattern_buffer *regexp_t;

/* bit definitions for syntax */
#define RE_NO_BK_PARENS          1   /* no quoting(ªª…±¸‰) for parentheses(·¹€¥©.)   */
#define RE_NO_BK_VBAR            2   /* no quoting for vertical bar */
#define RE_BK_PLUS_QM            4   /* quoting needed(¾‰€¹) for + and ? */
#define RE_TIGHT_VBAR            8   /* | binds(ª½¶‚‰¾¾.) tighter(º±¹©¾¹) than ^ and $ */
#define RE_NEWLINE_OR           16   /* treat(¹ˆ·‰ŽŠ¾¥Š) newline as or */
#define RE_CONTEXT_INDEP_OPS    32   /* ^$?*+ are special in all contexts */
#define RE_ANSI_HEX             64   /* ansi sequences(º¹ª±Š€-ª©¼) (\n etc) and \xhh */
...
#ifdef __STDProto__
char *re_av_chars(regexp_t bufp);
