...
**                      NO, otherwise.
*/
PUBLIC BOOL HTAA_templateMatch PARAMS((CONST char * _template,
				       CONST char * filename));
/*
 ...
 */
	...
	char *          proxy_authorization;  /* Proxy-Authorization: field */
 ...
 */
	...
	HTAARealm *     proxy_realm;    /* Proxy password realm           */
