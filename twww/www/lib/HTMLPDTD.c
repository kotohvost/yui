...
static attr base_attr[HTML_BASE_ATTRIBUTES+1] = {	/* BASE attributes */
	{ "HREF"},
	{ "TARGET"},
	{ 0 }	/* Terminate list */
};
...
static attr frame_attr[HTML_FRAME_ATTRIBUTES+1] = {		/* Frame */
	{ "NAME" },
	{ "NORESIZE" },
	{ "SRC" },
	{ 0 }	/* terminate list */
...
static attr script_attr[HTML_SCRIPT_ATTRIBUTES+1] = {		/* Script */
	{ "LANGUAGE" },
	{ "SRC" },
	{ 0 }	/* terminate list */
};

static attr frameset_attr[HTML_FRAMESET_ATTRIBUTES+1] = {	/* Frameset */
	{ "COLS" },
	{ "ROWS" },
	{ 0 }	/* terminate list */
};
...
static HTTag tags[HTMLP_ELEMENTS] = {
    ...
    { "FRAME" 	, frame_attr,	HTML_FRAME_ATTRIBUTES,	SGML_MIXED },
    ...
    { "OPTION"	, option_attr,	HTML_OPTION_ATTRIBUTES,	SGML_MIXED },/*Mixed?*/
    ...
    { "PRE"	, gen_attr,	HTML_GEN_ATTRIBUTES,	SGML_RCDATA /*SGML_MIXED*/ },
